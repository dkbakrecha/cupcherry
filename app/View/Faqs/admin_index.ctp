...
<div class="content-header">
    <h2 class="content-header-title"><i class="fa fa-question"></i> New - FAQ Page <a href="<?php echo $this->Html->url(array('controller' => 'faqs', 'action' => 'list', 'admin' => true)); ?>" class="btn btn-primary pull-right">Back</a></h2>
</div>
<div class="row"> 
