                    ...
                    <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="<?php echo $this->Html->url(array('plus'=>true,'controller'=>'users','action'=>'settings'));?>">Settings</a></li>
                             <li><a href="<?php echo $this->Html->url(array('plus'=>true,'controller'=>'users','action'=>'password'));?>">Password</a></li>
                            <li><a href="<?php echo $this->Html->url(array('plus'=>true,'controller'=>'users','action'=>'help'));?>">Help</a></li>
                            <li><a href="<?php echo $this->Html->url(array('plus'=>true,
                                'controller'=>'users',
                                'action'=>'logout'
                            ));?>">Logout</a></li>
                        </ul>
